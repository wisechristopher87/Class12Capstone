...
#Curl request to verify that owner was created

Kernel.system "curl -X GET #{admin:admin@http://clinic.doveryai-no-proveryai.com:9966/petclinic/api/owners"

if browser.text.include? Orlando
puts "Test pass"
else
puts "Test Fail"
end
